              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    icon: const Icon(Icons.add, color: EmColors.textSecondary),
                    onPressed: () {
...
class _ThreadTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      selected: selected,
      selectedTileColor: EmColors.surfaceTop.withValues(alpha: 0.18),
      title: Text(
        thread.title,
        maxLines: 1,
        overflow: TextOverflow.ellipsis,
        style: const TextStyle(
            color: EmColors.textPrimary, fontWeight: FontWeight.w500, fontSize: 14),
      ),
      subtitle: thread.lastMessagePreview.isEmpty
          ...
          : Text(
              ...
              maxLines: 1,
              overflow: TextOverflow.ellipsis,
              style: const TextStyle(color: EmColors.textTertiary, fontSize: 12),
            ),
      trailing: PopupMenuButton<String>(
        icon: const Icon(Icons.more_vert, size: 18, color: EmColors.textTertiary),
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text('Eliminar',
                style: TextStyle(color: EmColors.down)),
          ),
        ],
      ),
    );
    ...
    return const Center(
      child: Padding(
        ...
        child: Text(
          ...
          style: TextStyle(color: EmColors.textTertiary),
        ),
      ),
    );
  }
